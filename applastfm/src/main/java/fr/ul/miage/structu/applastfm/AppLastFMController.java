...
public class AppLastFMController {
	...
	public void initialize() {
		List<String> nomsPays = Arrays.asList("United States", "China", "Japan", "Germany", "United Kingdom", "India", "France", "Italy", "Canada", "South Korea", "Russia", "Australia", "Spain", "Brazil", "Netherlands", "Switzerland", "Mexico", "Indonesia", "Turkey", "Saudi Arabia", "Taiwan", "Iran", "Poland", "Sweden", "Thailand", "Belgium", "Argentina", "Norway", "United Arab Emirates", "Pakistan", "Israel", "Egypt", "Denmark", "Malaysia", "Philippines", "Singapore", "Greece", "Finland", "Iraq", "Vietnam", "Chile", "South Africa", "Algeria", "Colombia", "Nigeria", "Austria", "Ukraine", "Romania", "Czech Republic", "Portugal", "Peru", "Morocco", "Venezuela", "Serbia", "Hungary", "Slovakia", "New Zealand", "Ecuador", "Oman", "Belarus", "Bulgaria", "Azerbaijan", "Dominican Republic", "Tunisia", "Kazakhstan", "Libya", "Croatia", "Sudan", "Lebanon", "Uzbekistan", "Panama", "Costa Rica", "Lithuania", "Uruguay", "Slovenia", "Latvia", "Kenya");
		 ...
		 int choix = 0;
		   ...
		   if (nbrCheckBox<1) {
            ...
            case 2:
            	 ...
            	 //du 3eme element jusqu'a la fin de la liste les elements sont les noms des pistes de l'album
            	 
            	 String affichage = "l'album "+nomAlbum2.getText()+" de "+nomArtiste1.getText()+ " contient au totale "
            	 + resRequest2.get(0)+" morceaux. Sa durée totale est de "+resRequest2.get(1)+" secondes. \n"
